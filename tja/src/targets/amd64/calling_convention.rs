use crate::{
    ...
    mir::{self, BlockIdx, GenericInstruction, GenericRegister, Instruction, VregIdx},
    targets::{
            ...
            Ty::Struct(tys) => {
                for (i, &ty) in tys.iter().enumerate() {
                    self.classify(
                        ...
                        ty_storage,
                        ty,
                        A::field_offset(ty_storage, &tys, i),
                        eightbytes,
                    );
                }
            }
